Default binder on MyBinder: [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gl/gromacs%2Fonline-tutorials%2Fmembrane-protein/main?filepath=tutorial.ipynb)
